...
(2, '890ae7bd6c6e791463ff850291e3033d9de18a63', 'ken678', 'fcddf14938e6b150a10786d81d6aa0e36e787892', '530765310@qq.com', '美好时光总是很短暂的！！', '美好时光总是很短暂的！！', 0, 0, 3, 1458020135, 2059491498, 0, 0),
...
(7, '7707c456732f4e81b259133ffe061138ce806942', '御宅男', 'fcddf14938e6b150a10786d81d6aa0e36e787892', '530765312@qq.com', '御宅男工作室有多年的软件开发经验，专注于：软件制作，验证码识别，网站制作，采集工具，模拟操作，批量注册，群发软件，留言功能', '御宅男工作室有多年的软件开发经验，专注于：软件制作，验证码识别，网站制作，采集工具，模拟操作，批量注册，群发软件，留言功能', 2, 0, 2, 1458097833, 2059491498, 0, 0),
...
INSERT INTO `yzn_topics` (`id`, `uid`, `cid`, `nid`, `title`, `tags`, `content`, `reply_count`, `view`, `favourite`, `add_time`, `edit_time`, `reply_time`) VALUES
(15, 8, 2, 4, 'MarkDown语法测试', '', '## 大标题 ##\r\n### 小标题 ###\r\n\r\n*斜体文本* \r\n**粗体文本** \r\n***粗斜体文本*** \r\n\r\n文字链接 [链接名称](http://链接网址)\r\n网址链接 &lt;http://链接网址&gt;\r\n\r\n&gt; 引用文本前使用 [大于号+空格]\r\n&gt; 折行可以不加，新起一行都要加上哦\r\n\r\n&gt; 最外层引用\r\n&gt; &gt; 多一个 &gt; 嵌套一层引用\r\n&gt; &gt; &gt; 可以嵌套很多层\r\n\r\n&gt; - 这是引用里嵌套的一个列表\r\n&gt; - 还可以有子列表\r\n&gt;     * 子列表需要从 - 之后延后四个空格开始\r\n\r\n```\r\n代码块\r\n```\r\n\r\n---\r\n', 2, 0, 2, 1458624693, 0, 1458631963),
(23, 2, 2, 4, '这里测试@功能', 'member', '@&lt;a href=&quot;/member/int64ago&quot;&gt;int64ago&lt;/a&gt;', 7, 0, 0, 1458631986, 0, 1458703554),
(24, 2, 0, 4, '这里是回帖帖60秒限制测试', '', '这里是回帖60秒限制测试\r\n', 0, 0, 1, 1458637635, 0, 1458637635),
(25, 2, 0, 10, '本论坛源码下载.', '下载地址,源码下载,服务器,管理员,图片', '#说明\r\n------\r\n采用最新TP3.2.3框架\r\n使用sae作为服务器\r\n注册地址http://t.cn/R4ppkMF\r\nhttp://2.yznbbs.applinzi.com/不在维护\r\n\r\n#目前功能：（未完全完善）\r\n-------\r\n发帖 回帖 编辑\r\n@功能\r\n未读提醒功能\r\n60秒回帖限制\r\nmarkdown语法支持\r\n会员基础信息修改（密码 签名等）\r\n节点支持\r\n主题收藏 \r\n自动标签分词（DZ分词服务）\r\n\r\n#后期功能（）\r\n-------\r\n~~金币获取 发帖 回帖等方式~~\r\n~~关注用户~~\r\n~~管理后台~~\r\n~~附言~~\r\n~~赞 踩~~\r\n~~头像上传  附件上传  图片上传~~\r\n~~悬赏~~\r\n~~路由功能~~\r\n~~各类插件~~\r\n~~时间轴~~\r\n~~商城~~\r\n~~帖子置顶 隐藏~~\r\n~~节点查看 回复限制~~\r\n~~管理员 版主支持~~\r\n~~举报~~\r\n.....\r\n\r\n#下载地址\r\n------\r\ngithub地址：https://github.com/ken678/yznbbs\r\n\r\n\r\n\r\n\r\n\r\n', 0, 0, 2, 1458703742, 0, 1458703742),
(26, 7, 2, 10, '100000000000000000000', '', '10100000000000001231313', 14, 0, 0, 1458715486, 0, 1459159007),
(70, 2, 2, 4, '测试在线中文分词、关键词提取服务', '关键词,服务器,在线,中文,项目', '不同于使用自己的服务器进行分词，Discuz!在线中文分词服务是基于API返回分词结果的。在项目中，我们只需要一个函数即可方便地进行分词、关键词提取', 1, 0, 0, 1459230799, 0, 1459232810);
